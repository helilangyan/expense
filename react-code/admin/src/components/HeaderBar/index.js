...
class HeaderBar extends React.Component {
  ...
  render () {
    ...
    return (
      <div id='headerbar' style={{height:'50px',lineHeight:'50px',position:'relative'}}>

        <Icon
          type={collapsed ? 'menu-unfold' : 'menu-fold'}
          className='trigger'
          onClick={this.toggle}/>
          <Icon type="home" className='trigger' />
          <Icon type="robot" className='trigger'  />
          <Icon type="redo" className='trigger' />
