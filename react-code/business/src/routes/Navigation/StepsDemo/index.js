  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Card bordered={false} className='cardItem' title='基本使用'>
              <Steps current={2}>
            ...
            <Card bordered={false} className='cardItem' title='步骤运行错误'>
            ...
            <Card bordered={false} className='cardItem' title='步骤切换'>
          ...
          <Col span={12}>
            <Card bordered={false} className='cardItem' title='大小'>
            ...
            <Card bordered={false} className='cardItem' title='带图标'>
              <Steps>
            ...
            <Card bordered={false} className='cardItem' title='点状步骤条'>
