...
const props = {
  ...
  onChange(info) {
    if (info.file.status !== 'uploading') {
      // console.parameter(info.file, info.fileList);
    }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Card bordered={false} className='cardItem' title='基本用法'>
              <Upload {...props}>
          ...
          <Col span={12}>
            <Card bordered={false} className='cardItem' title='用户头像上传'>
            ...
            <Card bordered={false} className='cardItem' title='拖拽上传'>
              <Dragger {...props2}>
