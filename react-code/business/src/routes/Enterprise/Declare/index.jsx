  ...
  state = {
    ...
    columns: [
      ...
      },
      {
        ...
        render: (text, record) => (
          text == 0 ?
            <Button type="link" style={{ padding: '0' }}>立即付款</Button> :
            text == 1 ?
              <Button type="link" disabled style={{ padding: '0' }}>付款详情</Button> :
              text == 2 ?
                <Button type="link" danger style={{ padding: '0' }}>付款详情</Button> :
                <Button type="link" style={{ padding: '0' }}>付款详情</Button>
        ),
        width: 80
      },
    ],
