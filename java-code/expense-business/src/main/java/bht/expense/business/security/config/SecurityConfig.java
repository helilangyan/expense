package bht.expense.business.security.config;



import bht.expense.business.security.handler.MyAuthenticationFailureHandler;
import bht.expense.business.security.handler.MyAuthenticationSuccessHandler;
import bht.expense.business.security.jwt.JwtAuthTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/user/check-account").anonymous()
...
//                .hasAnyRole("ADMIN")  //admin角色可以访问
                ...
                // CRSF禁用，因为不使用session
                .csrf().disable().cors() ;//禁用跨站csrf攻击防御，允许跨域，否则无法登陆成功
        //登出功能
