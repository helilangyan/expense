package bht.expense.business.common;
...
public class TimeUtil {
     ...
     * @return
     */
    private List<Date> getBetweenDate(Date start, Date end) {
    ...
    /**
     * 返回2个日期间的日期集合 String格式
     * @param startTime
     * @param endTime
     * @return
     */
    public static List<String> getBetweenString(String startTime, String endTime) {
    ...
    /**
     * @Description: 将秒数转成天时分
     * @param mss 秒数
     * @Return java.lang.String
     */
    public static String getDayMinuteSecond(long mss) {
