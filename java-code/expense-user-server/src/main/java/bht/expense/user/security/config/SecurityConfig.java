package bht.expense.user.security.config;



import bht.expense.user.security.handler.MyAuthenticationFailureHandler;
import bht.expense.user.security.handler.MyAuthenticationSuccessHandler;
import bht.expense.user.security.jwt.JwtAuthTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/userinfo/check-account").anonymous()
