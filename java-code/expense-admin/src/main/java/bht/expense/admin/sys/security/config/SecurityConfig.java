package bht.expense.admin.sys.security.config;



import bht.expense.admin.sys.security.handler.MyAuthenticationFailureHandler;
import bht.expense.admin.sys.security.handler.MyAuthenticationSuccessHandler;
import bht.expense.admin.sys.security.jwt.JwtAuthTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .csrf().disable().cors().and() //禁用跨站csrf攻击防御，允许跨域，否则无法登陆成功
                // 认证失败处理类
